<?php
	...
	function add_comment_model($idBook,$username,$email,$content)
	{
		$checkFlag=FALSE;
		$conn=connection();
		...
		$status=0;
		$like_comment=0;
		$sql="INSERT INTO questions(username,email,content,create_time,id_book,status,like_comment) VALUES(:user,:email,:content,:create_time,:idbook,:status,:like_comment)";

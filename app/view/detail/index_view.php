 ...
 <div id="right">
        <section class="b-detail-holder">
            <article class="title-holder">
                <div class="span6">
                    <h2><?php echo $detail_data['TenSach']; ?></h2>
                </div>
            </article>
            <div class="book-i-caption">
                ...
                <div class="span6">
                    ...
                    <p class="text_chi_tiet">Nhà xuất bản:&#160;<a href=""><?php echo $detail_data['TenNXB'];?></a></p>
                    <p class="text_chi_tiet">Tác giả:&#160;<a href="?cn=home&method=author&idAuthor=<?php echo $detail_data['id_tg'];?>"><?php echo $detail_data['TenTG'];?></a></p>
                    <p class="text_chi_tiet">Thể loại:&#160;<a href="?cn=home&method=typebook&idTypeBook=<?php echo $detail_data['id_loai'];?>"><?php echo $detail_data['TenLoai'];?></a></p>
                    <p class="text_chi_tiet">Giá bìa:&#160;<?php echo number_format($detail_data['GiaCu']); ?>&#160;VNĐ</p>
                    ...
                    <p class="text_chi_tiet">Số trang:&#160;<?php echo $detail_data['SoTrang']; ?> trang</p>
                    ...
                    <div class="comm-nav">
                        ...
                        <ul>
                            ...
                            <li><input type="submit" value="Thêm vào giỏ hàng" class="more-btn btn-success"/></li>
                            </form>
                        </ul>
                    </div>
                </div>
            ...
            <section class="related-book">
                ...
                <div class="slider6">
                    <?php foreach ($data_type_book_same as $key => $value) {
                    ?>
                    <div class="slide">
                        ...
                        <h4><a href="?cn=detail&method=index&book=<?php echo vn2latin($value['TenSach'],TRUE)."-".$value['id'];?>"><?php echo $value['TenSach'];?></a></h4>
            ...
            <section class="reviews-section">
                ...
                <figure class="right-sec">
                    ...
                    <div style="width: 100%; margin-top:80px; height:650px; overflow-y:auto; overflow-x:hidden;">
                        ...
                        <div class="fb-comments" data-href="http://localhost/book/?cn=home" data-width="100%" data-numposts="10"></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#commentQuestion').click(function(event) {
            ...
            var idBook = <?php echo $detail_data['id'];?>;
            ...
            if(checkComment == 0)
            {
                if(username !='' && isEmail(email) && content !='' && captcha !='')
                {
                    $.ajax({
                        ...
                        type: 'POST',
                        //dataType: 'default: Intelligent Guess (Other values: xml, json, script, or html)',
                        data: {username: username, email: email, content: content, captcha: captcha, idBook: idBook},
                        success: function(data)
                        {
                            if(data=='err1')
                            {

              ...
              <table class="table table-hover table-striped" style="margin: 0px;padding: 0px;">
                  ...
                  ?>
                    <tr>
                        ...
                        <td class="center1"><?php echo $val['nameBook']; ?></td>
                        ...
                        <td class="center1"><a href="?cn=cart&m=delete&id=<?php echo $val['id'];?>"> <i class="icon-trash"></i></a></td>
                    </tr>
                  <?php $i++; } ?>
        ...
        <form id="enableForm3" action="?cn=cart&m=orders" method="POST" class="form-horizontal">
              ...
              <div class="col-md-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-md-offset-1">
                    <input class="myinput" type="text" placeholder="Nhập vào họ tên..." value="<?php echo $fullname;?>" class="form-control" name="txtHoTen" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-5 col-md-offset-1 control-label">Số điện thoại (*)</label>
                  <div class="col-md-6 col-md-offset-1">
                    <input class="myinput" type="text" placeholder="Nhập vào số điện thoại..." value="<?php echo $phone;?>" class="form-control" name="txtSoDienThoai" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-5 col-md-offset-1 control-label">Email (*)</label>
                  <div class="col-md-6 col-md-offset-1">
                    <input class="myinput" type="email" placeholder="Nhập vào email..." value="<?php echo $email;?>" class="form-control" name="txtEmail" />
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="col-md-7">
                    <input class="myinput" type="text" placeholder="Nhập vào địa chỉ..." value="<?php echo $address;?>" class="form-control" name="txtDiaChi" />
                  </div>
                </div>
                <div class="form-group">
          ...
          <div class="row">
            <div class="col-lg-12 text-center">
              <div class="form-group">
                  <input type="submit" name="btnOrder" class="btn btn-primary btn-block" style="width:30%; margin-top: 3em; font-size:1.3em;" value="Đặt hàng"/>
              </div>
            </div>
          </div>
        </form>

  ...
  <body>
    ...
    <div class="container">
		<div class="row m-auto p-4" >
			<div class="col-4" style="background-color: #fbfbfb; border-radius: 10px;" >
				<div class="page__one" >
					<div class="prinf">
						<nav>
							<p>In</p>
							<p>Tổng số: <span style="font-weight: bold">1Trang giấy</span></p>
							<div class="float-right" style="align-items: center">
									<button style="font-size: 12px;-webkit-margin-start: 9px;" class="btn btn-primary" type="submit">In</button>
									<span><button style="font-size: 12px;-webkit-margin-start: 9px;" class="btn" type="submit">Hủy</button></span>
							</div>
						</nav>
					</div>
			...
			<div class="col-8">
					<div class="title--page text-center mb-3">
						...
						<h6 class="float-right mt-1">Hà nội.Ngày 15 Tháng 6 Năm 2018</h6>
					</div>
					<div class="content--page " style="margin-top: 40px">
						<nav>
								<span>Tên Khách Hàng:</span>
								<span> Chu Văn Dương</span>
								<p>Địa Chỉ:<span> Mai dịch</span></p>
						</nav>

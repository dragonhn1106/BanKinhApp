	<section>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="col-md-6 well-sm">
						...
						<p><span class="glyphicon glyphicon-map-marker"></span>&#160;&#160;<strong>Address:</strong> Nam Tu Liem, Ha Noi, Vietnamese</p>
						<p><span class="glyphicon glyphicon-phone"></span>&#160;&#160;<strong>Hotline:</strong> +84 987501513</p>
						<p><span class="glyphicon glyphicon-envelope"></span>&#160;&#160;<strong>Email:</strong> doanquangdathd94@gmail.com</p>
					</div>
					<div class="col-md-6">
						<div class="row">
		...
		<script src="https://maps.googleapis.com/maps/api/js"></script>
			<script>
			var myCenter = new google.maps.LatLng(21.0528159,105.7342002);//tọa độ địa điểm
			function initialize() {
			var mapProp = {
  				center:myCenter,
  				zoom:12,

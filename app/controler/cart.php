<?php
	...
	function add_cart()
	{
		...
		{
			if(isset($_SESSION['cart'][$idbook]) && $_SESSION['cart'][$idbook]==$idbook)
			{
				$_SESSION['cart'][$idbook]['qty'] += $qty;
			}
			else
			{
				$_SESSION['cart'][$idbook]['id']=$idbook;
				$_SESSION['cart'][$idbook]['nameBook']=$detail_data['TenSach'];
				$_SESSION['cart'][$idbook]['HinhAnh']=$detail_data['HinhAnh'];
				$_SESSION['cart'][$idbook]['GiaCu']=$detail_data['GiaCu'];
				$_SESSION['cart'][$idbook]['qty']=$qty;
			}
		}
		else
	...
	function delete_cart()
	{
		...
		if(is_numeric($idbook) && $idbook > 0)
		{
			if(isset($_SESSION['cart'][$idbook]['id']) && $_SESSION['cart'][$idbook]['id']==$idbook)
			{
